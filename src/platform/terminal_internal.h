...
AFORC_INTERNAL AFORC_Status aforc_terminal_write_best_effort(int fd,
                                                             const void *data,
                                                             size_t size);
...
aforc_terminal_query_dimensions(AFORC_Terminal *terminal, bool *out_changed);
...
AFORC_INTERNAL void
aforc_terminal_activate_process_state(const AFORC_Terminal *terminal);
...
AFORC_INTERNAL AFORC_Status
aforc_terminal_open_signal_pipe(AFORC_Terminal *terminal);
...
AFORC_INTERNAL AFORC_Status
aforc_terminal_install_actions(AFORC_Terminal *terminal);
