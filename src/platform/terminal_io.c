...
AFORC_Status aforc_terminal_write_best_effort(int fd,
                                          const void *data,
                                          size_t size)
{
...
static AFORC_Status aforc_terminal_emit(AFORC_Terminal *terminal,
                                    const char *sequence)
{
    return aforc_terminal_write_fd(terminal->config.output_fd,
                                 sequence,
                                 strlen(sequence));
}
