 ...
 * ISO-HDLC polynomial. The surrounding AForc adapter is MIT-licensed; the
 * generated table retains this zlib notice:
 *
...
uint32_t aforc_save_crc32(const uint8_t *data, size_t size)
{
