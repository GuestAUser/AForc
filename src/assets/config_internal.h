...
AFORC_ASSETS_INTERNAL bool aforc_config_index_contains(
    const AFORC_ConfigIndex *index,
    const AFORC_ConfigEntry *entries,
    AFORC_ConfigRange section,
    AFORC_ConfigRange key);
AFORC_ASSETS_INTERNAL void aforc_config_index_insert(
    AFORC_ConfigIndex *index,
    const AFORC_ConfigEntry *entries,
    size_t entry_index);
...
AFORC_ASSETS_INTERNAL AFORC_Status aforc_config_duplicate_range(
    AFORC_ConfigRange range,
    char **output);
AFORC_ASSETS_INTERNAL void aforc_config_entries_release(
    AFORC_ConfigEntry *entries,
    size_t count);
AFORC_ASSETS_INTERNAL AFORC_Status aforc_config_builder_append(
