...
AFORC_ASSETS_INTERNAL void aforc_save_store_u16(
    uint8_t *destination,
    uint16_t value);
AFORC_ASSETS_INTERNAL void aforc_save_store_u32(
    uint8_t *destination,
    uint32_t value);
AFORC_ASSETS_INTERNAL void aforc_save_store_u64(
    uint8_t *destination,
    uint64_t value);
...
AFORC_ASSETS_INTERNAL bool aforc_save_bounded_writer_write_bytes(
    ...
    const void *source,
    size_t size);
AFORC_ASSETS_INTERNAL bool aforc_save_bounded_writer_write_u16(
    AFORC_SaveBoundedWriter *writer,
    uint16_t value);
AFORC_ASSETS_INTERNAL bool aforc_save_bounded_writer_write_u32(
    AFORC_SaveBoundedWriter *writer,
    uint32_t value);
AFORC_ASSETS_INTERNAL bool aforc_save_bounded_writer_write_u64(
    AFORC_SaveBoundedWriter *writer,
    uint64_t value);
...
AFORC_ASSETS_INTERNAL uint32_t aforc_save_crc32(
    const uint8_t *data,
    size_t size);
AFORC_ASSETS_INTERNAL bool aforc_save_writer_valid(
