...
AFORC_Status aforc_alloc_array(const AFORC_Allocator *allocator,
                               size_t count,
                               size_t element_size,
                               void **out_memory)
{
...
AFORC_Status aforc_realloc_array(const AFORC_Allocator *allocator,
                                 void *memory,
                                 size_t count,
                                 size_t element_size,
                                 void **out_memory)
...
void aforc_error_set(AFORC_Error *error,
                     AFORC_Status status,
...
void aforc_log(const AFORC_Logger *logger,
