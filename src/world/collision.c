...
AFORC_Status aforc_grid_point_blocked(const AFORC_TileMap *map, uint32_t layer,
                                  AFORC_Point point,
...
AFORC_Status aforc_grid_rect_blocked(const AFORC_TileMap *map, uint32_t layer,
                                 AFORC_Rect rect,
                                 AFORC_TileTestFn is_blocked, void *context,
                                 bool *out_blocked,
