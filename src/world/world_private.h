...
AFORC_WORLD_PRIVATE size_t aforc_world_point_index_internal(
    const AFORC_TileMap *map, AFORC_Point point);
AFORC_WORLD_PRIVATE size_t aforc_world_tile_index_internal(
    const AFORC_TileMap *map, uint32_t layer, AFORC_Point point);

AFORC_WORLD_PRIVATE AFORC_Status aforc_world_validate_layer_internal(
...
AFORC_WORLD_PRIVATE bool aforc_world_tile_matches_internal(
    const AFORC_TileMap *map, uint32_t layer, AFORC_Point point,
    AFORC_TileTestFn predicate, void *context);
