...
typedef AFORC_Status (*AFORC_EngineHookFn)(void *context,
                                           AFORC_Engine *engine,
                                           AFORC_Error *error);
...
AFORC_API AFORC_Status aforc_engine_run(AFORC_Engine *engine,
                                        AFORC_Error *error);
...
AFORC_API AFORC_Status aforc_engine_frame(AFORC_Engine *engine,
                                          uint64_t now_ns,
                                          AFORC_Error *error);
...
AFORC_API const AFORC_EngineConfig *
aforc_engine_config(const AFORC_Engine *engine);
