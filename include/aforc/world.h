...
AFORC_API AFORC_Status aforc_tilemap_cell_count(const AFORC_TileMap *map,
                                                size_t *out_count);
AFORC_API bool aforc_tilemap_contains(const AFORC_TileMap *map,
                                      AFORC_Point point);
...
AFORC_API AFORC_Status aforc_camera_init(AFORC_Camera *camera,
                                         AFORC_Size viewport);
...
AFORC_API AFORC_Status aforc_path_workspace_create(
    const AFORC_Allocator *allocator, AFORC_PathWorkspace **out_workspace);
AFORC_API AFORC_Status aforc_path_workspace_reserve(
    AFORC_PathWorkspace *workspace, size_t cell_capacity);
...
aforc_pathfind_astar_workspace(AFORC_PathWorkspace *workspace,
                               const AFORC_TileMap *map,
                               uint32_t layer,
                               AFORC_Point start,
                               AFORC_Point goal,
