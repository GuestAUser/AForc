...
typedef AFORC_Status (*AFORC_SceneEnterFn)(AFORC_Scene *scene,
                                           AFORC_Engine *engine,
                                           AFORC_Error *error);
typedef void (*AFORC_SceneStateFn)(AFORC_Scene *scene, AFORC_Engine *engine);
typedef AFORC_Status (*AFORC_SceneUpdateFn)(AFORC_Scene *scene,
                                            AFORC_Engine *engine,
                                            double seconds,
                                            AFORC_Error *error);
typedef AFORC_Status (*AFORC_SceneRenderFn)(AFORC_Scene *scene,
                                            AFORC_Engine *engine,
                                            double interpolation,
                                            AFORC_Error *error);
typedef AFORC_Status (*AFORC_SceneEventFn)(AFORC_Scene *scene,
                                           AFORC_Engine *engine,
                                           const void *event,
                                           bool *consumed,
                                           AFORC_Error *error);
